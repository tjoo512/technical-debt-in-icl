...
# , PolynomialsUnbiasedPoints, PolynomialsDegTwoMonomialSelectionUnbiased, NoisyLinearRegressionTaskDiversity, FourierSeriesV2Multitask, LegendrePoly
import time
...
def eval_model(
    ...
    for i in range(num_eval_examples // batch_size): # every iteration creates a batch
        ...
        metrics = eval_batch(model, task_sampler, xs, eval_ood, xs_p,
